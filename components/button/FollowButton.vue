<template>
  <div
    v-if="user.id != idUserCreator" class="hover:cursor-pointer"
    @click="isFollow ? unFollowCreator() : followCreator()">
    <div
      v-if="!miniSize"
    ...
    <div
      ...
      <Icon v-if="!isFollow" name="mdi:plus" size="20" color="white"/>
      <Icon v-else name="ion:checkmark" size="20" color="white"/>
